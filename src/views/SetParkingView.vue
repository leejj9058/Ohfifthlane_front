  ...
  <div class="d-flex justify-content-center align-items-center p-3" id="background">
    ...
    <div class="p-4 p-md-5 w-100 ">
      ...
      <div class="table-responsive">
        ...
        <p class="mt-3 mb-2" style="font-size: 15px; color: gray;">※ 자치구(또는 공단)에 신청한 정보와 맞지 않을 경우 등록이 되지 않을 수 있습니다.</p>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-primary" data-bs-dismiss="modal" @click="gotoTimesetView">확인</button>
            </div>
          </div>
        </div>
      </div>
